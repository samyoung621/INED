/* 設定：接上 Google Sheet、球隊名稱、規定打席門檻。設定存在瀏覽器。 */
...
window.SBViews.settings = function (season) {
  ...
  frag.appendChild(U.card('球隊資訊', null, el('div', { class: 'form-grid' }, [
    ...
    field('qualifyingPAPerGame', '規定打席係數', '規定打席 = 場次 × 這個數字，目前為 ' + season.minPA + ' 打席', 'number'),
  ...
  function renderMode() {
    ...
    modeHost.appendChild(U.seg(
      [{ label: '示範資料', value: 'demo' }, { label: 'Google Sheet', value: 'sheet' }],
  ...
  frag.appendChild(U.card('資料來源', null, el('div', {}, [
    ...
    el('div', { class: 'form-grid' }, [
      ...
      field('tabPlayers', '球員分頁名稱', null, 'text', cfg.tabs.players),
      field('tabGames', '比賽分頁名稱', null, 'text', cfg.tabs.games),
      field('tabAtbats', '打席分頁名稱', null, 'text', cfg.tabs.atbats)
    ]),
